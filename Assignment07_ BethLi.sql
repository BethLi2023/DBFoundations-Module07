...
-- 2023-11-28,BethLi,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_BethLi')
	 Begin 
	  Alter Database [Assignment07DB_BethLi] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_BethLi;
	 End
	Create Database Assignment07DB_BethLi;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_BethLi;
...
SELECT P.ProductName, [InventoryDate] = DateName(MM, I.InventoryDate) + ',' + DateName(YY, I.InventoryDate), 
...
AS 
  SELECT Top 1000000 P.ProductName, [InventoryDate] = Datename(MM, I.InventoryDate) + ',' + DateName(YY, I.InventoryDate), 
                     [InventoryCount] = I.[Count]
   FROM vProducts as P 
    INNER JOIN vInventories as I 
	ON P.ProductID = I.ProductID
...
AS 
 SELECT TOP 1000000 C.CategoryName, [InventoryDate] = Datename(MM, I.InventoryDate) + ',' + DateName(YY, I.InventoryDate), 
...
AS 
 SELECT TOP 1000000 ProductName, InventoryDate, InventoryCount, 
...
AS 
  SELECT TOP 1000000 ProductName, InventoryDate, InventoryCount, [PreviousMonthCount], 
